...
#ifdef WIN32
	sprintf( g_pLogCfg->s8LogFileName, "%sLogFile-%04d%02d%02d%02d%02d%02d.txt",
		g_pLogCfg->s8LogPath, nowtime->tm_year+ 1900,nowtime->tm_mon + 1,nowtime->tm_mday,nowtime->tm_hour,nowtime->tm_min,nowtime->tm_sec); 
#else
	sprintf( g_pLogCfg->s8LogFileName, "%s/LogFile-%04d%02d%02d%02d%02d%02d.txt",
		g_pLogCfg->s8LogPath, nowtime->tm_year+ 1900,nowtime->tm_mon + 1,nowtime->tm_mday,nowtime->tm_hour,nowtime->tm_min,nowtime->tm_sec); 
#endif
