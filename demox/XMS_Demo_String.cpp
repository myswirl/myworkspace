...
char *GetString_DeviceSub ( DJ_S32	s32DeviceSub )
{
	...
	case XMS_DEVSUB_HIZ_PRI_LINK:				return "HIPRILI";
	case XMS_DEVSUB_HIZ_SS7_64K_LINK:			return "HSS764L";
	case XMS_DEVSUB_HIZ_SS7_2M_LINK:			return "HSS72ML";
	case XMS_DEVSUB_SS7_LINK:					return "SS7LINK";
	case XMS_DEVSUB_LINESIDE:					return "LINSIDE";
	case XMS_DEVSUB_ANALOG_REC:					return "A_REC";
	case XMS_DEVSUB_DIGITAL_REC:				return "D_REC";
	case XMS_DEVSUB_HIZ_HDLC_N64K_LINK:			return "HDLC64L";	
	}
