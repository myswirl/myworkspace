...
// Dialog Data
	...
	CComboBox	m_ComboLayer0ParaMode;
	CComboBox	m_ComboLayer0LoadMode;
...
protected:
	...
	afx_msg void OnSelchangeTabParamedit(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnSelchangeComboLayer0Loadmode();
	afx_msg void OnSelchangeComboLayer0Parallelmode();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
